---
name: release-notes
description: Generate grouped, human-readable release notes from the git log between two refs (tags, branches, or commits). Use when the user asks to draft release notes, a changelog entry, or "what changed since <ref>". Trigger on "/release-notes" or any request to summarise commits for a release.
---
